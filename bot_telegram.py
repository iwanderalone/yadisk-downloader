...
CACHE_LIFETIME = 300
WAIT_DATE_RANGE, WAIT_FEEDBACK = range(2)  # Состояния диалогов
...
# ==================== УНИВЕРСАЛЬНЫЙ ПАРСЕР ОДНОЙ ДАТЫ ====================
...
def main():
    ...
    # Диалоговый менеджер для кастомного периода и фидбека.
    # Он перехватывает кнопки меню и управляет состояниями диалога.
    ...
    # Бот пришлет меню с предложением выбрать нужную кнопку.
